...
class PendingVolunteersTest < ActionDispatch::IntegrationTest
  ...
  test "Merge pending volunteer into volunteer" do  # pending_volunteer is the source, volunteer is the target
    log_in_as(@non_admin)
    ...
    source_use_field_list = [:first_name, :last_name, :home_phone]
