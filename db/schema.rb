...
ActiveRecord::Schema.define(version: 2020_03_27_203806) do
  ...
  create_table "homeowners_projects", id: false, force: :cascade do |t|
    t.bigint "project_id", null: false
    t.bigint "volunteer_id", null: false
    t.index ["project_id", "volunteer_id"], name: "index_homeowners_projects_on_project_id_and_volunteer_id", unique: true
    t.index ["project_id"], name: "index_homeowners_projects_on_project_id"
    t.index ["volunteer_id"], name: "index_homeowners_projects_on_volunteer_id"
  end
